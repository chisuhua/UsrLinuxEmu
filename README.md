...
> **架构与构建相关信息以本 README + AGENTS.md + core-architecture.md (SSOT) 为准**。`docs/02_architecture/architecture.md` 与 `architecture_design.md` 已**归档**至 [docs/archive/misc/](docs/archive/misc/)（最后验证 2026-06-16 commit `374d463`，pre-v0.1.5 内容），请改读 SSOT。
