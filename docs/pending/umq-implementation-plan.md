...
- 在 ioctl 表中增加 0x40-0x43 的预留范围说明
...
- 删除 `GPU_IOCTL_REGISTER_LAUNCH_CB` (ADR-024 分析确认该回调设计不合理) — ✅ **已删除 (commit `b78edc9`)**
- 清理 `GpgpuDevice::launch_cb_` 和 `GpgpuDevice::handleRegisterLaunchCb` — ✅ **已完成 (commit `b78edc9`)**
