...
| [tadr-301](../external/TaskRunner/docs/shared/adr/tadr-301-igpu-driver-contract.md) | IGpuDriver 28→31 方法契约 (H-5 新增, H-3.5 扩展) | [ADR-032](adr-032-h2-5-igpu-driver-abstraction.md) |
