...
**状态**: 🔄 提议中（C-12 Phase C.0.3 降级决策已批准 2026-07-16: Phase C.2.3 使用 multi-thread single-process 方案，不改动本 ADR 的 Phase 1/2 完整多进程支持方向；本 ADR 继续等待 Phase 3 触发条件）

**日期**: 2026-03
**最后更新**: 2026-07-16（C-12 mini-gate C.0.3 降级决策）
