...
| [架构决策记录](00_adr/README.md) | 所有 ADR（001–024，缺 022）|
...
| 类别 | 说明 |
|------|------|
| [进行中的计划](pending/) | gpu_driver_portability / linux_compat / umq |
...
| ADR | 23 | 90% | 2026-06-16 |

**总体进度**: 约 **85%** 完成（Phase 2 + P0 cleanup 后）

### ADR 编号说明

`docs/00_adr/` 当前收录 **23 份** ADR，编号范围 **001–024**，**缺失 ADR-022**：

- ✅ 已收录：001, 002, 003, 004, 005, 006, 007, 008, 009, 010, 011, 012, 013, 014, 015, 016, 017, 018, 019, 020, 021, 023, 024
- ❌ **未启动**：022（"GPU 计算单元仿真"） — 占位编号
