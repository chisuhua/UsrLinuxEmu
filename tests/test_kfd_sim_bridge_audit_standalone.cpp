/*
 * test_kfd_sim_bridge_audit_standalone.cpp — C-12 B.3.5 audit
 *
 * Verifies:
 *  1. sim_pm_* still callable from bridge (legacy marker preservation)
 *  2. Every kfd_sim_handle_* function has a LEGACY/CLEAN marker comment
 */
...
/* ── Test Case 1: sim_pm_* still callable from bridge ────────────── */
