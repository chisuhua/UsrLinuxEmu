...
| **阶段 3** | 🔄 进行中 | v1.0 稳定（CUDA E2E ✅、sanitizer ✅、bridge ✅、perf ✅、错误处理、文档）| [docs/roadmap/stage-3-v1.0.md](docs/roadmap/stage-3-v1.0.md) |
...
| `stage3-2-hotpath-optimization` | 🔵 P3 | PR #30 | ✅ COMPLETED (2026-07-11) | ioctl 11.6× / pushbuffer 1296× / BO 2.1×，PASS 2/3 |
...
```
1. Stage 3.3 错误处理审计 (全路径 Linux 错误码审计, 18 tasks)
2. Stage 3.4 文档完善 (Doxygen API 参考 + docs-audit 43/43 PASS)
3. v1.0 发布清单 (Release notes + Migration guide + Binary release)
```
