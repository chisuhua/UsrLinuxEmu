...
# Design: complete-event-page-writeback

## Overview

本 change 的设计来源于 `improvements/complete-event-page-writeback.md`，详细架构依据 + 范围 + 关键场景 + 验收标准见该文件。
...
1. 阅读 `improvements/complete-event-page-writeback.md` 中的「范围」节，确认 in-scope 文件列表
