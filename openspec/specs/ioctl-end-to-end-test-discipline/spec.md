# ioctl-end-to-end-test-discipline Specification

## Purpose
TBD - created by archiving change add-e2e-tests-for-register-gpu-and-map-queue-ring. Update Purpose after archive.
## Requirements
